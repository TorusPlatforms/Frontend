...
const LoopsPage = () => {
    ...
    const toggleNotifications = () => {
      ...
      return (
        <View style={{  paddingTop: 20, backgroundColor: "rgb(22, 23, 24)" }}>
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          <Text style={{color:"white", fontSize:20, alignSelf:"center"}}>{exampleLoopData.description}</Text>
            ...
            <View style={{backgroundColor: 'rgb(50,50,50)', alignSelf:"center", marginTop:50,width:"80%", borderRadius:20 }}>
            <TouchableOpacity 
            onPress={() => navigation.navigate("DirectMessage", {username: "Announcements"})}
            style={{alignSelf: 'center',marginTop:10, backgroundColor: 'rgb(50,50,50)', paddingVertical: 15,paddingHorizontal: 50, borderRadius: 40,zIndex:0}}>
