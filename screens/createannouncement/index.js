      ...
      <SafeAreaView style={styles.container}>
        <ScrollView refreshControl={<RefreshControl refreshing={refreshing} tintColor={"white"}/>}>
          ...
          <View style={{ flexDirection: "column", alignItems: "center"}}>
            ...
            <TouchableOpacity disabled={content.length <= 0} style={{ backgroundColor: content.length > 0 ? "rgb(47, 139, 128)" : "gray", borderRadius: 20, borderWidth: 1, borderColor: "black", paddingVertical: 10, paddingHorizontal: 20, marginTop: 20 }} onPress={handlePost}>
